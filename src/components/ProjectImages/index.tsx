				...
				<For each={props.images} fallback={<div>Loading...</div>}>
					{(item, index) => (
						<ImageZoom
							...
							class="scale-100 cursor-zoom-in self-center overflow-hidden rounded-xl border border-gray-200 shadow transition-transform duration-300 motion-safe:hover:scale-106 motion-safe:focus:scale-106"
